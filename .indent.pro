-kr // Base on K&R Style
-bad -bbb // Blank lines around block comments and declaration blocks
-sc // Stars on left edge of multi-line comments
-cdw // Cuddle do-while like we do if-the-else
